...
var pricingMap = map[string]map[string]int{
    "৬ষ্ঠ": {
        "ডায়মন্ড প্যাক": 400, // 5% of 8000
        "গোল্ড প্যাক": 250,    // 5% of 5000
        "গোল্ড প্যাক (রেকর্ডেড)": 200, // 5% of 4000
    },
    "৭ম": {
        "ডায়মন্ড প্যাক": 400, // 5% of 8000
        "গোল্ড প্যাক": 250,    // 5% of 5000
    ...
    "৯ম": {
        "ডায়মন্ড প্যাক": 500, // 5% of 10000
        "গোল্ড প্যাক": 350,    // 5% of 7000
        "গোল্ড প্যাক (রেকর্ডেড)": 200, // 5% of 4000
    },
    "১০ম": {
        "ডায়মন্ড প্যাক": 375, // 5% of 7500
        "গোল্ড প্যাক": 200,    // 5% of 4000
        "গোল্ড প্যাক (রেকর্ডেড)": 225, // 5% of 4500
    },
}
